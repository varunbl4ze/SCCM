...
class User(db.Model):
    ...
    # foreign_keys is required here because Complaint now has two FKs to
    # users (user_id = owner, assigned_admin_id = admin handling it) —
    # without it, SQLAlchemy can't tell which FK this relationship means.
